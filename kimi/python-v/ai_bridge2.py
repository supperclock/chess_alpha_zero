...
def _load_library():
    ...
    lib_path = os.path.join(os.path.dirname(__file__), 'c_engine/gemini2', lib_name + lib_ext)
...
def find_best_move_c2(board_state_py, side_py, max_depth=16, time_limit=5):
    """
